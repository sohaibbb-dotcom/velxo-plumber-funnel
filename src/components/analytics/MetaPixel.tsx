 ...
 * as soon as React commits, which can happen before next/script's
 * "afterInteractive" strategy has actually run the bootstrap script, so
 * relying on this effect for the *first* PageView is a race that would
 * silently drop the call. Skipping the first run here avoids double-firing
 * against the bootstrap script's own PageView.
 */
