...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-white pt-3 pb-24 sm:pt-[calc(var(--nav-h)+2.5rem)] sm:pb-32 lg:pt-[calc(var(--nav-h)+3.5rem)]">
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        <motion.div
          ...
          custom={0}
          variants={fadeUp}
          className="mb-3 flex justify-center sm:mb-6"
        >
          <Badge>
        ...
        */}
        ...
        <motion.p
          ...
          custom={2}
          variants={fadeUp}
          className="mx-auto mt-3 max-w-xl text-base leading-relaxed text-zinc-600 sm:mt-6 sm:text-lg"
        >
        ...
        <motion.div
          ...
          custom={3}
          variants={fadeUp}
          className="mt-4 flex flex-col items-center justify-center gap-3 sm:mt-8 sm:flex-row"
        >
          <a
            href={TRIAL_CTA_HREF}
        ...
        <motion.p
          ...
          custom={4}
          variants={fadeUp}
          className="mt-2 text-xs font-medium text-zinc-400 sm:mt-4"
        >
      ...
      <motion.div
        ...
        className="relative mx-auto mt-3 max-w-6xl px-4 sm:mt-20 sm:px-6 lg:px-8"
      >
        <HeroProductDemo />
      </motion.div>
    </section>
